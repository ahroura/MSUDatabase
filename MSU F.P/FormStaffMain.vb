...
Public Class FormStaffMain
    ...
    Private Sub IconButton6_Click(sender As Object, e As EventArgs) Handles IconButton6.Click
        ActivateButton(sender, RGB.color6)
        OpenChildForm(New FormStaffOrderView)
    End Sub
    ...
    Private Sub FormStaffMain_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
